...
$ride_id = $_GET["id"];
$q = mysqli_query($db, "select * from ride where ride_id='$ride_id'") or die(mysqli_error($db));
    ...
    <div class="nav-wrapper">
      ...
      <div class="nav-wrapper">
       ...
       <div class="row" style="padding:0px;">
        <h5 style="padding:5px;font-family: 'Laila', cursive;font-weight: bold;">Edit a ride </h5>
         <div class="col s7 " style="font-family: 'Quicksand', sans-serif;">
          <form method="post" onsubmit="return checkForm(this)">
          <div class="grey lighten-2 nav-wrapper z-depth-2" style="padding: 5px;">
           <div class="input-field">
            <i class="material-icons prefix">location_on</i>
            <input id="origin-input" type="text" name="fromloc" class="controls" value="<?php echo"$from";?>">
            <label for="origin-input">From Location</label>
          </div>
          <div class="input-field">
            <i class="material-icons prefix">location_searching</i>
            <input id="destination-input" type="text" name="toloc" class="controls" value="<?php echo"$to";?>">
            <label for="destination-input">To Location</label>
          </div>
          <div class="input-field">
            <i class="material-icons prefix">attach_money</i>
            <input id="price" type="text" class="validate" name="price" value="<?php echo"$price";?>">
            <label for="price">Price per Pessenger</label>
          </div>
        </div>

        <div class="white z-depth-2" style="padding:5px;font-family: 'Quicksand', sans-serif;">
         <div class="input-field">
          <i class="material-icons prefix">date_range</i>
          <input id="date" type="text" class="datepicker" name="date" value="<?php echo"$dt";?>">
          <label for="date">Date</label>
        </div>
        <div class="input-field">
          <i class="material-icons prefix">access_time</i>
          <input id="time" type="text" class="timepicker" name="time" value="<?php echo"$time";?>">
          <label for="time">Time</label>
        </div>
      </div>

      <div class="grey lighten-2 nav-wrapper z-depth-2" style="padding:5px;font-family: 'Quicksand', sans-serif;">
        <label>Select Car</label>
        <select class="browser-default" name="car">
          <option value="" style="font-family: 'Quicksand', sans-serif;" disabled selected>Choose your option</option>
          <?php
      ...
      echo "<option value='".$carid."'>".$carname." - ".$carplate."</option>";
        ...
        <label>Select Seat Offered</label>
      ...
      <div class="grey lighten-2 nav-wrapper z-depth-2" style="padding:25px;height: 80px;">
        <button class="btn waves-effect waves-light right light-blue darken-1" type="submit" name="action" style="font-family: 'Boogaloo', cursive;">Edit
        </button>
      </div>
